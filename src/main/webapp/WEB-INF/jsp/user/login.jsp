...
<div class="wrapper">
    ...
    <div class="froyo-frame login-body">
        <div class="admin-face">
            <div class="face-img">
                <img src="${ctxStatic}/images/yiqing.png" alt="logo">
            </div>
        </div>
        <h1 class="admin-login-tittle">「疫情论坛交流系统」</h1>
        <div class="admin-login-form">
            <form class="form" action="${ctx}/login" method="post" autocomplete="off">
                ...
                <div class="admi0n-button"><button type="submit" id="login-button">登录</button></div>
                <div class="admi0n-button"><a id="return-button" href="${ctx}/index">返回首页</a></div>
            </form>
          <!--   其他账号登录：
