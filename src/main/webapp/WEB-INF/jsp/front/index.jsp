                        ...
                        <li>
                            ...
                            <div class="fly-list-info">
                                <a href="user/home.html" link>
                                    ...
                                    <i class="layui-badge fly-badge-vip">正常</i>
                                </a>
                                <span><fmt:formatDate value="${news.createDate}" pattern="yyyy-MM-dd"/></span>
                                <span class="fly-list-kiss layui-hide-xs" title="浏览次数"><i class="iconfont icon-kiss"></i> ${news.read}</span>
                                <a href="${ctx}/third/${news.id}"/><span class="layui-badge fly-badge-accept layui-hide-xs">阅读全文</span></a>
                                <span class="fly-list-nums"> <i class="iconfont icon-pinglun1" title="回答"></i> ${news.comments}</span>
                            </div>
                        </li>
